...
| POST | `/agentmemory/full/extraction-baseline` |
...
| POST | `/agentmemory/full/semantic-rollup-eligibility` |
| POST | `/agentmemory/full/skill-extract` |
| POST | `/agentmemory/full/skill-extract-eligibility` |
